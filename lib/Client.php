...
class Client extends TaxJar
{
    ...
    /**
     * Get tax categories
     * https://developers.taxjar.com/api/reference/?php#list-tax-categories
     *
     ...
     * https://developers.taxjar.com/api/reference/?php#show-tax-rates-for-a-location
     *
     * @param int $zip
     ...
     * https://developers.taxjar.com/api/reference/?php#calculate-sales-tax-for-an-order
     *
     * @param array $parameters
     *
     ...
     * https://developers.taxjar.com/api/reference/?php#list-order-transactions
     *
     * @param array $parameters
     *
     ...
     * https://developers.taxjar.com/api/reference/?php#show-an-order-transaction
     *
     ...
     * https://developers.taxjar.com/api/reference/?php#create-an-order-transaction
     *
     * @param array $parameters
     *
     * @return object Order object.
     ...
     * https://developers.taxjar.com/api/reference/?php#update-an-order-transaction
     *
     * @param integer @transaction_id
     * @param array $parameters
     *
     ...
     * https://developers.taxjar.com/api/reference/?php#delete-an-order-transaction
     *
     * @param integer $transaction_id
     * @param array $parameters
     *
     ...
     * https://developers.taxjar.com/api/reference/?php#list-refund-transactions
     *
     * @param array $parameters
     *
     ...
     * https://developers.taxjar.com/api/reference/?php#show-a-refund-transaction
     *
     * @param integer $transaction_id
     * @param array $parameters
     *
     ...
     * https://developers.taxjar.com/api/reference/?php#create-an-refund-transaction
     *
     * @param array $parameters
     *
     * @return object Order object.
     ...
     * https://developers.taxjar.com/api/reference/?php#update-an-refund-transaction
     *
     * @param array $parameters
     *
     * @return object Order object.
     ...
     * https://developers.taxjar.com/api/reference/?php#delete-a-refund-transaction
     *
     * @param integer $transaction_id
     * @param array $parameters
     *
